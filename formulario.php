 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'contacto@triboquimia.com.mx');
   /**
    ...
    */   
   define('CC_FB_BCC_EMAIL', 'alberto.cisneros@sofnet.com.mx');
    ...
    */  
   define('CC_FB_AUTO_REPLY_SUBJECT', 'Tribioquimia, gracias en breve nos comunicaremos.');   
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'respuesta.html');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $auto_reply_msg = 'Gracias por hacernos llegar sus comentarios en este momento se esta revizando para su canalización al area competente,
vigilando su seguimiento y pronta respuesta.

Si desea hacer un comentario vía telefónica nos puede contactar a través del los teléfonos 58 84 26 19 ò 58 84 91 02 '
;
